...
* Password: 123456
### 1.2. Page User (Minh họa danh sách sự kiện và phần "Liên kết xã hội", "Thông tin liên lạc" ở footer)
...
* Ban tổ chức sự kiện, doanh nghiệp, nhà trường
...
* Theo dõi – phân tích hiệu quả truyền thông, tối ưu SEO và tương tác người dùng.
* Đảm bảo bảo mật, quyền riêng tư dữ liệu và phát triển theo quy trình SDLC chuyên nghiệp.
...
* Xem thông báo, lịch trình, kết quả sự kiện

📌 **Lưu ý**: Người dùng **không có quyền quản trị**, không chỉnh sửa dữ liệu, không duyệt nội dung và không truy cập các chức năng hệ thống nội bộ.
...
* Thu thập sự đồng ý cho:
  ...
  * Sử dụng hình ảnh/video sự kiện
  * Nhận thông báo, email truyền thông
...
* Ghi lại các hành động quan trọng:
  ...
  * Đăng nhập / đăng xuất
  * Cập nhật chính sách
  * Thay đổi trạng thái consent
* Phục vụ kiểm tra, truy vết và minh bạch dữ liệu
...
* Mở rộng dashboard phân tích dữ liệu sự kiện
* Kết nối hệ thống bán vé, QR Check-in
...
* **Mục đích**: Phục vụ học tập, nghiên cứu và mô phỏng hệ thống thực tế

---

📌 *Tài liệu README này dùng để mô tả tổng quan hệ thống, phục vụ giảng viên, sinh viên và các bên liên quan trong quá trình đánh giá và phát triển dự án.*
